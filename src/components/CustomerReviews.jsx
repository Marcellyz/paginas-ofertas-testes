...
const CustomerReviews = () => {
    ...
    const reviewsData = [
        ...
        name: "Amanda Luna",
        date: "22/08/2024",
        comment: "Ótimo livro, amei! O livro veio em ótimas condições. Amei a leitura e recomendo a todos!",
        rating: "⭐⭐⭐⭐⭐",
        },
        {
        name: "Alexandra Silva",
        date: "22/08/2024",
        comment: "Leitura interessante. O livro veio em ótimas condições. Amei a leitura e recomendo a todos!",
        rating: "⭐⭐⭐⭐☆",
        },
    ];
